    ...
    def post(self, request):
        ...
        try:
            ...
            for _, row in df.iterrows():
                ...
                # Simple date handling (if string) -> You might need strict parsing
                ...
                students_to_create.append(Student(
                    ...
                    # exam_date is tricky if format varies. Leaving 'None' if parse fails or assume standard format for now.
                    # In real production, use dateutil.parser
                    exam_date=None, 
